package com.voit.Calc.View.Customs;
...
public class MyCustomScrollPane extends JScrollPane {
    ...
    public MyCustomScrollPane(Component view, int vsbPolicy, int hsbPolicy) {
        ...
        verticalScrollBar.setUI(new com.voit.Calc.View.Customs.MyCustomScrollbar());

        JScrollBar horizontalScrollBar = getHorizontalScrollBar();
        horizontalScrollBar.setOpaque(false);
        horizontalScrollBar.setUI(new com.voit.Calc.View.Customs.MyCustomScrollbar());

        setLayout(new com.voit.Calc.View.Customs.MyScrollPaneLayout());
